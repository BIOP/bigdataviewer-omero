...
public class OmeroSourceRGB24bits extends OmeroSource<ARGBType> {
    public OmeroSourceRGB24bits(OmeroSourceOpener opener, int c) throws Exception {
        super(opener, c);
    }
    ...
    public RandomAccessibleInterval<ARGBType> createSource(int t, int level) {
        ...
        try {
            ...
            final Img<ARGBType> rai = factory.create(new long[]{sx, sy, sz}, new ARGBType(),
                    cell -> {
                        ...
                        try {
                            synchronized (OmeroTools.class) {
                                ...
                                // TODO convert bytes for this type of format
